        ...
        <div className="my-12">
            ...
            <div className="grid base:grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {products.map((product) => {
                    return (
                        <a href="#">
                            <div className="flex flex-col gap-2 bg-gray-600 transition relative product">
                                <div className="absolute bg-gray-100/75 w-full h-full opacity-0 hover:opacity-100 transition">
                                    <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-100 text-center">
                                        <Button className="bg-white text-brown-500 hover:bg-brown-500 hover:text-white transition">Add to cart</Button>
            ...
            <div className="flex justify-center my-6">
                <Button variant="outlined" color="brown" className="font-normal w-[250px]">
                    Show More
                </Button>
            </div>
        </div>
